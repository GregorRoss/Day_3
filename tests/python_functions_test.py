...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_volume_of_cube(self):
    length = 10
    cube_volume = volume_of_cube(length)
    self.assertEqual(1000, cube_volume)
    #add test code above

  #Given a String, return the String reversed
  
  def test_reverse_string(self):
    string_reversed = reverse_string("Gregor")
    self.assertEqual("rogerG", string_reversed)
    #add test code here
  ...
  def test_fahrenheit_to_celsius(self):
    F_to_C = fahrenheit_to_celsius(98.6)
    self.assertEqual(37, F_to_C)
    #add test code here
